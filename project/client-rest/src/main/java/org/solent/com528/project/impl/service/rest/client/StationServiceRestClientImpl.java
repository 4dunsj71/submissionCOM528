...
public class StationServiceRestClientImpl implements ServiceFacade {
    ...
    private ClientObjectFactoryImpl cofi = new  ClientObjectFactoryImpl();
    ...
    public TicketMachineDAO getTicketMachineDAO() {
        if (ticketMachineDAO == null) {
            ...
            synchronized (this) {
                if (ticketMachineDAO == null) {
                    ServiceFacade serviceFacade = cofi.getServiceFacade();
                    ticketMachineDAO = serviceFacade.getTicketMachineDAO();
                }
            }
        }
