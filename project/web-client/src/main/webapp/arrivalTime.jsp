...
<html>
    ...
    <body>
        ...
        <h1>Select an arrival Time</h1>
            

        <p>you are departing at:<%=depTime%></p>
        <table border ="1">
            <tr>
                <th>Select an Arrival Time:</th>    
            </tr>
            <%
                for(int x=0;x<24;x++){
            %>
            <tr>
                ...
                <td>
                    <form action="./ticketMachine.jsp" method="get">
                        <input type="hidden" name ="arrTime" value="<%=dateArray[x].getTime()%>">
                        ...
                        <input type="hidden" name="depTime" value="<%=depTimeStr%>">
                        <input type="hidden" name="action" value="SelectArrTime">
