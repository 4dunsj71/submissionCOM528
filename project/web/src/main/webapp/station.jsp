...
<%
    ...
    if ("createStation".equals(actionStr)) {
        ...
        if (stationName == null) {
            ...
            //find station with DAO
            station = stationDAO.findByName(stationName);
            //make a new ticketMachine object
            TicketMachine tm = new TicketMachine();
            //set the station of the new TicketMachine as the station retrieved
            tm.setStation(station);
            //save the ticketMachine in the database via DAO
            ticketMachineDAO.save(tm);
            String uuid = tm.getUuid();
            //check if DAO can find ticketMachine by uuid
            if(ticketMachineDAO.findByUuid(uuid) != null){
            message = "Ticket Machine Created"+"<br><br>"+"Refresh Page To View";
            }
